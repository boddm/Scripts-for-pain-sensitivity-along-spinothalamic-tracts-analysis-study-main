function myPLS_table_loadings(var_type, var_PLS_type, vars_PLS, vars_std, vars_lB, vars_uB, save_opts,var_names,signif_LC)
...
for iLC = 1:length(signif_LC)
    ...
    file_name = fullfile(save_opts.output_path, [save_opts.prefix, '_LC', num2str(this_lc), '_', var_type, '_', var_PLS_type, '.csv']);
