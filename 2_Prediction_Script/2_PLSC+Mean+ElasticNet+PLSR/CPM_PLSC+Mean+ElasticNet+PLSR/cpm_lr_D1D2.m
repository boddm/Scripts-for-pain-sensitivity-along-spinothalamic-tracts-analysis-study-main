...
%% Set default secondary selection parameters if none are provided
if nargin < 8 || isempty(selector_options)
    % Keep default PLSC process
    selector_options = struct('method', 'none');
end

%% Get feature selection mask and regression coefficients
...
%% Predict test set behavioral scores using selected features and regression coefficients
